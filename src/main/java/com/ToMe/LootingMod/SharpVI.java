 ...
 */
public class SharpVI extends /*Enchantment*//*EnchantmentDamage*/DamageEnchantment {

    //public SharpVI(Enchantment.Rarity rarityIn, int damageTypeIn, /*EntityEquipmentSlot...*/EntityEquipmentSlot[] slots)
    public SharpVI(Enchantment.Rarity rarityIn, int damageTypeIn, EquipmentSlotType[] slots)
    {
