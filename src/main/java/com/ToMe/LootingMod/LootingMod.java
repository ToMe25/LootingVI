...
public class LootingMod {
	...
	public LootingMod() {
		if(cfg == null) {
			...
			File cfg = new File(FMLPaths.CONFIGDIR.get().toString(), MODID + ".toml");
	...
	@SubscribeEvent
	public static void registerEnchant(final RegistryEvent.Register<Enchantment> event) {
		//IForgeRegistry registry = event.getRegistry();
		IForgeRegistry<Enchantment> registry = event.getRegistry();
		//registry.register(CreeperKill.setRegistryName("CreeperKill"));
		if(cfg.EnableCreeperKill) {
			//registry.register(CreeperKill.setRegistryName("CreeperKill"));
			registry.register(CreeperKill.setRegistryName("creeperkill"));
			//registry.register(CreeperKill);
		}
	}
	...
	//public void LoadEnchants() {
		...
		//if(cfg.EnableCreeperKill) {
			//ForgeRegistries.ENCHANTMENTS.register(CreeperKill.setRegistryName("CreeperKill"));
			//ForgeRegistries.ENCHANTMENTS.register(CreeperKill);
			//GameRegistry.register(CreeperKill.setRegistryName("CreeperKill"));
			//GameRegistry.register(CreeperKill);
		//}
		//ForgeRegistries.ENCHANTMENTS.register(CreeperKill.setRegistryName("CreeperKill"));
		//CreeperKill.REGISTRY.register(11, new ResourceLocation("lootingmod:" + "CreeperKill"), CreeperKill.setRegistryName("CreeperKill"));
